...
export default async function PublicMatchPage({
  ...
  const publicGridClass = (segmentStart: number) =>
    segmentStart === 1
      ? "grid grid-cols-[92px_repeat(9,minmax(24px,1fr))_38px] sm:grid-cols-[220px_repeat(9,minmax(78px,1fr))_96px]"
      : "grid grid-cols-[92px_repeat(9,minmax(24px,1fr))_38px_38px] sm:grid-cols-[220px_repeat(9,minmax(78px,1fr))_96px_96px]";
  const publicMinWidth = (segmentStart: number) => (segmentStart === 1 ? 346 : 384);
  ...
  const publicBodyCellClass = "px-1.5 py-2 text-center sm:px-3 sm:py-3";
  const publicScoreCircleClass = "h-7 w-7 text-[14px] leading-none tracking-[-0.02em] sm:h-12 sm:w-12 sm:text-xl";
